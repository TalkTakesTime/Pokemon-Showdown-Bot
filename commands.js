...
exports.commands = {
	...
	choose: function(arg, by, room, con) {
		...
		if ((capsMatch && toId(choice).length > 18 && (capsMatch.length >= Math.floor(toId(choice).length * 0.8))) || (stretchMatch) || (choice.match(/snen/g) && choice.match(/snen/g).length > 6)) botAbuse = true;
